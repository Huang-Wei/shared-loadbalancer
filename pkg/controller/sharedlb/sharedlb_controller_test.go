...
var svcKey = types.NamespacedName{Name: "foo-service", Namespace: "default"}
...
func TestReconcile(t *testing.T) {
	...
	instance := &kubeconv1alpha1.SharedLB{
		...
		Spec: kubeconv1alpha1.SharedLBSpec{
	...
	// Create the SharedLB object and expect the Reconcile and Service to be created
